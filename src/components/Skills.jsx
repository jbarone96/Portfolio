    ...
    <section className="text-gray-600 body-font">
      <div className="p-4 pt-0 mt-5 mx-auto md:p-5 md:mx-20 lg:mx-32 xl:mx-56">
        ...
        <div
          ...
          data-aos-once="false"
          className="px-2 py-6 grid justify-center items-center grod-cols-3 gap-x-3 gap-y-6 sm:grid-cols-4 md:py-5 lg:grid-cols-6 border-t-gray-200 border-2 rounded-md md:shadow-md"
        >
