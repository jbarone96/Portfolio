        ...
        <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-12 sm:gap-x-3 md:gap-x-5 lg:gap-x-2 lg:gap-y-5 xl:gap-x-5 xl:gap-y-10 mt-4 md:mt-8">
          {ProjectsData.reverse().map((project) => (
            ...
            >
              ...
              />
              <div className="absolute flex flex-col justify center items-center button-0 left-0 right-0 h-0 overflow-hidden group-hover:h-full trasnition-[height_0.5s] duration-500 bg-darkblue rounded-xl">
