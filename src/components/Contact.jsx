...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    emailjs
      .sendForm("service_irbszjh", "template_71abe19", formRef.current)
      .then(
        () => {
  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="px-3 py-5 mx-auto text-center md:mt-7 sm:mx-12 lg:mx-32 xl:mx-56">
          ...
          >
            ...
            >
              <textarea
                ...
                placeholder="Message"
                name="message"
                className="mb-1 w-full bg-white rounded-md border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-black p-2 resize-none leading-6 transition-colors duration-200 east-in-out"
              />
            </div>
            <div
              data-aos="zoom-in-up"
