        ...
        <div className="flex flex-col md:grid grid-cols-9 mx-auto text-blue-50">
          {ExperienceData?.reverse().map((exp, idx) => {
            ...
            return isLeft ? (
                  ...
                  <div className="flex w-fit mt-auto">
                    <ul className="pl-3 md:pl-5 list-disc leading-loose max-w-max text-[15px] text-start md:text-base font-medium">
                      {exp?.desc?.map((desc, idx) => (
                        <li key={idx} className="mb-1 md:mb-2">
                          {desc}
                        </li>
                      ))}
                    </ul>
              ...
              <div key={idx} className="flex md:contents text-start">
                <div className="col-start-5 cold-end-6 md:mx-auto relative mr-3 md:mr-10">
                  <div className="h-full w-4 flex items-center justify-center">
                    <div className="h-full w-[3px] bg-dark-orange/50"></div>
                  </div>
                  <div className="w-4 h-4 absolute top-4 rounded-full bg-dark-orange shadow">
                ...
                <div
                  ...
                  data-aos-duration="1500"
                  data-aos-once="false"
                  className="bg-slate-100 text-gray-700 col-start-6 col-end-10 p-2.5 md:p-4 rounded-lg mr-auto shadow-md"
                >
                  <h3 className="text-lg md:text-xl font-semibold mb-1">
                    {exp.title}
                  </h3>
