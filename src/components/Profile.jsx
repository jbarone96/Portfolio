    ...
    >
      <div className="p-5 mx-auto gap-2 flex flex-col md:pt-12 md:px-7 lg:py-20 lg:flex-row-reverse items-center min-h-fit">
        <div
          ...
          data-aos-once="false"
          className="w-5/6 sm:max-w-xs md:max-w-sm lg:max-w-md sm:w-2/6 lg:mr-10 xl:mr-20 lg:p-5 lg:-1/3 xl:w-1/4"
        >
          <img
        ...
        <div className="lg:flex-grow lg:pr-4 lg:mr-14 flex flex-col md:mb-0 items-center text-center xl:scale-105">
          ...
          {ProfileData.info?.map((item, idx) => (
            <p
              key={idx}
              data-aos="zoom-in-up"
              data-aos-duration="2000"
              data-aos-onc="false"
              className="mb-2 text-white texxt-lg md:text-xl leading relaxed"
            >
              {item}
            </p>
          ))}
